			...
			<div class="site_access">
				...
				<dl class="dl-horizontal">
					...
					<?php if (!empty($value['facebook'])): ?>
						...
						<dd>
							<a href="https://www.facebook.com/<?php echo $value['facebook']; ?>" target="_blank">
					...
					<?php if (!empty($value['odnoklassniki'])): ?>
						...
						<dd>
							<a href="https://ok.ru/profile/<?php echo $value['odnoklassniki']; ?>" target="_blank">
			...
			<div class="contacts">
				...
				<dl class="dl-horizontal">
					...
					<?php if (!empty($value['contacts_instagram'])): ?>
						...
						<dd>
							<a href="https://instagram.com/<?php echo $value['contacts_instagram']; ?>" target="_blank">
					...
					<?php if (!empty($value['contacts_odnoklassniki'])): ?>
						...
						<dd>
							<a href="https://ok.ru/<?php echo $value['contacts_odnoklassniki']; ?>" target="_blank">
