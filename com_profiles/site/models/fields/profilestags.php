...
class JFormFieldProfilesTags extends JFormFieldList
{
	...
	public function setup(SimpleXMLElement $element, $value, $group = null)
	{
		...
		{
			$this->name     = '';
			$this->value    = Route::_(ProfilesHelperRoute::getListRoute($this->value));
	...
	protected function getOptions()
	{
		...
		$root->value = Route::_(ProfilesHelperRoute::getListRoute(1));
		...
		if (!empty($tags) && is_array($tags))
		{
			...
			foreach ($objects as $i => $tag)
			{
				...
				$option->value = Route::_(ProfilesHelperRoute::getListRoute($id));
